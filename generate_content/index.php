...
<body>
  ...
  <form id="input-form">
    <div id="content-container">
      <p><b>Instructions:</b> Please enter the following information, and the API will bring back cases that match your criteria. From there you can choose which cases the AI should summarize and auto-generate blog posts for.</p>
